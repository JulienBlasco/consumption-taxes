...
* modified 29 June to add differentiated rates with quintiles
* modified 17 July to add differentiated rates with percentiles
*******************
...
global quvars_obs												///
	hmc	dhi	 hmchous	dhi_percentile /* hchous  									///
	hmc_wor_scaled 		hmc_scaled  							///    
	prop_scaled  		prop_wor_scaled 	*/	///
	itrc_ours itrc_carey itrc_euro
...
multiple_csv fr10, model(2) n_quantiles(10) print test quiet
