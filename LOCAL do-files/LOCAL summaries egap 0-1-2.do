...
label variable Gini_ours_wor0 "Constant tax rate on non-housing consumption"
...
label variable global_rate_wor0 `""Constant tax rate" "on non-housing consumption""'
...
yscale(range(0 0.3)) yla(0(0.05)0.35) // scheme(s2mono) 
